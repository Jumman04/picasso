...
class RequestCreatorTest {
  ...
  private val picasso = spy(mockPicasso(ApplicationProvider.getApplicationContext()))
  private val bitmap = makeBitmap()

  @Test
  fun getOnMainCrashes() {
    try {
  ...
  @Test
  fun getReturnsNullIfNullUriAndResourceId() {
  ...
  @Test
  fun fetchWithMemoryPolicyNoCache() {
    RequestCreator(picasso, URI_1, 0).memoryPolicy(NO_CACHE).fetch()
  ...
  @Test
  fun intoTargetNoPlaceholderCallsWithNull() {
  ...
  @Test
  fun intoTargetWithNullUriAndResourceIdSkipsAndCancels() {
    val target = mockBitmapTarget()
  ...
  @Test
  fun intoTargetWithQuickMemoryCacheCheckDoesNotSubmit() {
    `when`(picasso.quickMemoryCacheCheck(URI_KEY_1)).thenReturn(bitmap)
    val target = mockBitmapTarget()
  ...
  @Test
  fun intoTargetWithSkipMemoryPolicy() {
    val target = mockBitmapTarget()
  ...
  @Test
  fun intoTargetAndNotInCacheSubmitsTargetRequest() {
    val target = mockBitmapTarget()
    val placeHolderDrawable = mock(Drawable::class.java)
  ...
  @Test
  fun targetActionWithDefaultPriority() {
  ...
  @Test
  fun targetActionWithCustomPriority() {
  ...
  @Test
  fun targetActionWithDefaultTag() {
    RequestCreator(picasso, URI_1, 0).into(mockBitmapTarget())
    verify(picasso).enqueueAndSubmit(actionCaptor.capture())
  ...
  @Test
  fun intoDrawableTargetWithFitThrows() {
    try {
  ...
  @Test
  fun intoDrawableTargetNoPlaceholderCallsWithNull() {
  ...
  @Test
  fun intoDrawableTargetWithNullUriAndResourceIdSkipsAndCancels() {
    val target = mockDrawableTarget()
    val placeHolderDrawable = mock(Drawable::class.java)
    RequestCreator(picasso, null, 0).placeholder(placeHolderDrawable).into(target)
    verify(picasso).defaultBitmapConfig
  ...
  @Test
  fun intoDrawableTargetWithQuickMemoryCacheCheckDoesNotSubmit() {
    `when`(picasso.quickMemoryCacheCheck(URI_KEY_1)).thenReturn(bitmap)
    val target = mockDrawableTarget()
    RequestCreator(picasso, URI_1, 0).into(target)
  ...
  @Test
  fun intoDrawableTargetWithSkipMemoryPolicy() {
    val target = mockDrawableTarget()
    RequestCreator(picasso, URI_1, 0).memoryPolicy(NO_CACHE).into(target)
    verify(picasso, never()).quickMemoryCacheCheck(URI_KEY_1)
  }
  ...
  @Test
  fun intoDrawableTargetAndNotInCacheSubmitsTargetRequest() {
    val target = mockDrawableTarget()
    val placeHolderDrawable = mock(Drawable::class.java)
    RequestCreator(picasso, URI_1, 0).placeholder(placeHolderDrawable).into(target)
    verify(target).onPrepareLoad(placeHolderDrawable)
  ...
  @Test
  fun intoImageViewWithNullUriAndResourceIdSkipsAndCancels() {
  ...
  @Test
  fun intoImageViewWithQuickMemoryCacheCheckDoesNotSubmit() {
    val cache = PlatformLruCache(0)
    val picasso = spy(
      Picasso(
        ApplicationProvider.getApplicationContext(),
        mock(Dispatcher::class.java),
        UNUSED_CALL_FACTORY,
        null,
        cache,
        null,
  ...
  @Test
  fun intoImageViewSetsPlaceholderDrawable() {
    val cache = PlatformLruCache(0)
    val picasso = spy(
      Picasso(
        ApplicationProvider.getApplicationContext(),
  ...
  @Test
  fun intoImageViewNoPlaceholderDrawable() {
    val cache = PlatformLruCache(0)
    val picasso = spy(
      Picasso(
        ApplicationProvider.getApplicationContext(),
  ...
  @Test
  fun intoImageViewSetsPlaceholderWithResourceId() {
    val cache = PlatformLruCache(0)
    val picasso = spy(
      Picasso(
        ApplicationProvider.getApplicationContext(),
    ...
    assertThat(shadowOf(drawableCaptor.value).createdFromResId).isEqualTo(android.R.drawable.picture_frame)
    verify(picasso).enqueueAndSubmit(actionCaptor.capture())
    assertThat(actionCaptor.value).isInstanceOf(ImageViewAction::class.java)
  }

  @Test
  fun cancelNotOnMainThreadCrashes() {
  ...
  @Test
  fun intoNotOnMainThreadCrashes() {
  ...
  @Test
  fun intoImageViewAndNotInCacheSubmitsImageViewRequest() {
    val target = mockImageViewTarget()
    RequestCreator(picasso, URI_1, 0).into(target)
    verify(picasso).enqueueAndSubmit(actionCaptor.capture())
    assertThat(actionCaptor.value).isInstanceOf(ImageViewAction::class.java)
  ...
  @Test
  fun intoImageViewWithFitAndNoDimensionsQueuesDeferredImageViewRequest() {
  ...
  @Test
  fun intoImageViewWithFitAndDimensionsQueuesImageViewRequest() {
    val target = mockFitImageViewTarget(true)
  ...
  @Test
  fun intoImageViewWithSkipMemoryCachePolicy() {
    val target = mockImageViewTarget()
    RequestCreator(picasso, URI_1, 0).memoryPolicy(NO_CACHE).into(target)
    verify(picasso, never()).quickMemoryCacheCheck(URI_KEY_1)
  }
  ...
  @Test
  fun intoImageViewWithFitAndResizeThrows() {
    try {
      val target = mockImageViewTarget()
  ...
  @Test
  fun imageViewActionWithDefaultPriority() {
    RequestCreator(picasso, URI_1, 0).into(mockImageViewTarget())
    verify(picasso).enqueueAndSubmit(actionCaptor.capture())
    assertThat(actionCaptor.value.request.priority).isEqualTo(NORMAL)
  }
  ...
  @Test
  fun imageViewActionWithCustomPriority() {
  ...
  @Test
  fun imageViewActionWithDefaultTag() {
    RequestCreator(picasso, URI_1, 0).into(mockImageViewTarget())
    verify(picasso).enqueueAndSubmit(actionCaptor.capture())
    assertThat(actionCaptor.value.tag).isEqualTo(actionCaptor.value)
  }
  ...
  @Test
  fun imageViewActionWithCustomTag() {
  ...
  @Test
  fun intoRemoteViewsWidgetQueuesAppWidgetAction() {
  ...
  @Test
  fun intoRemoteViewsNotificationQueuesNotificationAction() {
  ...
  @Test
  fun intoRemoteViewsWidgetWithPlaceholderDrawableThrows() {
    try {
  ...
  @Test
  fun intoRemoteViewsWidgetWithErrorDrawableThrows() {
    try {
  ...
  @Test
  fun intoRemoteViewsNotificationWithPlaceholderDrawableThrows() {
    try {
      RequestCreator(picasso, URI_1, 0).placeholder(ColorDrawable(0))
  ...
  @Test
  fun intoRemoteViewsNotificationWithErrorDrawableThrows() {
    try {
      RequestCreator(picasso, URI_1, 0).error(ColorDrawable(0))
        .into(mockRemoteViews(), 0, 0, mockNotification())
      fail("Calling into() with error drawable should throw exception")
  ...
  @Test
  fun intoRemoteViewsWidgetWithFitThrows() {
    try {
  ...
  @Test
  fun intoRemoteViewsNotificationWithFitThrows() {
    try {
      val remoteViews = mockRemoteViews()
  ...
  @Test
  fun intoTargetNoResizeWithCenterInsideOrCenterCropThrows() {
    try {
  ...
  @Test
  fun appWidgetActionWithDefaultPriority() {
    RequestCreator(picasso, URI_1, 0).into(mockRemoteViews(), 0, intArrayOf(1, 2, 3))
    verify(picasso).enqueueAndSubmit(actionCaptor.capture())
    assertThat(actionCaptor.value.request.priority).isEqualTo(NORMAL)
  }
  ...
  @Test
  fun appWidgetActionWithCustomPriority() {
  ...
  @Test
  fun notificationActionWithDefaultPriority() {
    RequestCreator(picasso, URI_1, 0).into(mockRemoteViews(), 0, 0, mockNotification())
    verify(picasso).enqueueAndSubmit(actionCaptor.capture())
    assertThat(actionCaptor.value.request.priority).isEqualTo(NORMAL)
  }
  ...
  @Test
  fun notificationActionWithCustomPriority() {
  ...
  @Test
  fun appWidgetActionWithDefaultTag() {
    RequestCreator(picasso, URI_1, 0).into(mockRemoteViews(), 0, intArrayOf(1, 2, 3))
    verify(picasso).enqueueAndSubmit(actionCaptor.capture())
    assertThat(actionCaptor.value.tag).isEqualTo(actionCaptor.value)
  }
  ...
  @Test
  fun appWidgetActionWithCustomTag() {
  ...
  @Test
  fun notificationActionWithDefaultTag() {
    RequestCreator(picasso, URI_1, 0).into(
  ...
  @Test
  fun notificationActionWithCustomTag() {
    RequestCreator(picasso, URI_1, 0).tag("tag").into(mockRemoteViews(), 0, 0, mockNotification())
    verify(picasso).enqueueAndSubmit(actionCaptor.capture())
    assertThat(actionCaptor.value.tag).isEqualTo("tag")
  }
  ...
  @Test
  fun transformationListImplementationValid() {
  ...
  @Test
  fun imageViewActionWithStableKey() {
  ...
  @Test
  fun imageViewActionWithCustomHeaders() {
    RequestCreator(picasso, URI_1, 0).addHeader(CUSTOM_HEADER_NAME, CUSTOM_HEADER_VALUE)
      .into(mockImageViewTarget())
    verify(picasso).enqueueAndSubmit(actionCaptor.capture())
    assertThat(actionCaptor.value.request.headers!![CUSTOM_HEADER_NAME]).isEqualTo(
      CUSTOM_HEADER_VALUE
    )
  }

  @Test
  fun imageViewActionWithCustomHeadersCopiesHeaders() {
    RequestCreator(picasso, URI_1, 0).addHeader(CUSTOM_HEADER_NAME, CUSTOM_HEADER_VALUE)
      .into(mockImageViewTarget())
    verify(picasso).enqueueAndSubmit(actionCaptor.capture())
